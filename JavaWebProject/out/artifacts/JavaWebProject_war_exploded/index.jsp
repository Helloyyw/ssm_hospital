          ...
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">科室导航</h4>
                <p>内科学（传染病）、神经病学.....</p>
              </div>
            </div>
          </a>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">专家预约</h4>
                <p>医院拥有一大批学术技术造诣高...</p>
              </div>
            </div>
          </a>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">医院概况</h4>
                <p>前身为始建于1892年的重庆“宽仁医院”......</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col-xs-6 col-md-4">
          <a href="#">
            <div class="media">
              ...
              <div class="media-body">
                <h4 class="media-heading">新闻动态</h4>
                <p>有感染性疾病分子生物学教育部重点实验室</p>
              </div>
            </div>
          </a>
        </div>
