...
<%
    ...
    List<Leaveword> leavewordList1 = (List<Leaveword>)request.getAttribute("leavewordList");
	List<Leaveword> leavewordList = new ArrayList<>();
	if(session.getAttribute("user_name") == null ){
		leavewordList = leavewordList1;
	}else {
		for (Leaveword leaveword : leavewordList1) {
			if (session.getAttribute("user_name").toString().equalsIgnoreCase(leaveword.getUserObj().getUser_name())) {
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Leaveword/leaveword_frontAdd.jsp">添加留言</a></li>
				</ul>
			  	<!-- Tab panes -->
