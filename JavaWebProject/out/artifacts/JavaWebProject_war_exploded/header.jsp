...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">草街人人民医院</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
...
//				  	String user_name = (String)session.getAttribute("user_name");
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/frontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的预约查询</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我要留言</a></li>
                        <li><a href="<%=basePath %>UserInfo/userInfo_frontModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改个人资料</a></li>
                        <li><a href="<%=basePath %>Leaveword/frontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的留言</a></li>
                    </ul>
                </li>
...
function register() {
    location.href = "<%=basePath %>UserInfo/userInfo_frontAdd.jsp";
