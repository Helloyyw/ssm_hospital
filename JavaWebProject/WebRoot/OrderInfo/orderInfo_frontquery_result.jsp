...
<%
    ...
    List<OrderInfo> orderInfoList1 = (List<OrderInfo>)request.getAttribute("orderInfoList");

	List<OrderInfo> orderInfoList = new ArrayList<>();
	for(OrderInfo orderInfo: orderInfoList1) {
		System.out.println(orderInfo.getUserObj().getUser_name()+"=="+session.getAttribute("user_name"));
		if(session.getAttribute("user_name").toString().equalsIgnoreCase(orderInfo.getUserObj().getUser_name())){
		...
		<div class="col-md-9 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>OrderInfo/orderInfo_frontAdd.jsp" >添加预约信息</a></li>
				</ul>
			  	<!-- Tab panes -->
